...
* DevoFlow: scaling flow management for high-performance networks [CONTROLLERS]
* Devoflow: Cost-effective flow management for high performance enterprise networks [CONTROLLERS]
...
* Flowvisor: A network virtualization layer [CONTROLLERS]
...
* HotSwap: correct and efficient controller upgrades for software-defined networks [CONTROLLERS]
...
* NOX: towards an operating system for networks [CONTROLLERS]
...
* Resource/accuracy tradeoffs in software-defined measurement [CONTROLLERS]
...
* Scalable Network Virtualization in Software-Defined Networks [CONTROLLERS]
...
* Scalable software defined network controllers [CONTROLLERS]
